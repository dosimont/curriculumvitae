\section{Experience}
\esp
\cventry{October 2015}{Postdoctoral Researcher}{CIST, Paris VII University}{Inria, Montbonnot 
Saint-Martin (Grenoble Area), France}{}{
\textbf{Technical expert - Geomedia platform}\\
 \textbf{Keywords: Web application, Java, Tomcat, RSS}
}
\esp
...
\begin{itemize}
 \item Design of overview methods based on data aggregation for the analysis of voluminous execution traces.
 \item Design and implementation of an open-source analysis tool, \textbf{Ocelotl}, and a data aggregation library, \textbf{LPAggreg}. 
 \\Contributor in the development of the \textbf{Framesoc} analysis infrastructure.
...
\esp
\cventry{2010 (2 Months)}{Research Engineer}{LIP6, Paris VI University}{Paris, France}{}{
\textbf{Design space exploration of a telecommunication application}\\
